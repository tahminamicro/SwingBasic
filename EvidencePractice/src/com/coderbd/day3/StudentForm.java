...
public class StudentForm extends javax.swing.JFrame {
    ...
    private void btnADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnADDActionPerformed
        ...
        gender = rFemale.getText();
         ...
         course += chkHTML.getText();
          ...
          Student s = new Student(name, id, gender, course, round, comment);
          list.add(s);
          
            try {
                Utility.writeMethod("Tahmina", list);
            } catch (Exception e) {
            }
        }
    ...
    private void btnFromFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFromFileActionPerformed
        ...
        DefaultTableModel model= (DefaultTableModel)tblDisplay.getModel();
        Utility.readFromFile(JOptionPane.showInputDialog("File Name"), model);
